...
public class ColoreoAleatorioTest {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][] {
				{ Archivos.ARCHIVO_40_ADYACENCIA.getArchivo() + ".in", Archivos.ARCHIVO_40_ADYACENCIA.getArchivo() },
				{ Archivos.ARCHIVO_60_ADYACENCIA.getArchivo() + ".in", Archivos.ARCHIVO_60_ADYACENCIA.getArchivo() },
				{ Archivos.ARCHIVO_90_ADYACENCIA.getArchivo() + ".in", Archivos.ARCHIVO_90_ADYACENCIA.getArchivo() } };
